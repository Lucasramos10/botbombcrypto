...
bot = telegram.Bot(token="5044240470:AAFL0BRGxFu_L204lJGo1-qUkMDT-IRddRQ")


def telegram_bot_sendtext(bot_message, num_try=0):
    global bot
    try:
        return bot.send_message(chat_id="1263299119", text=bot_message)
    except:
        if num_try == 1:
            bot = telegram.Bot(token="5044240470:AAFL0BRGxFu_L204lJGo1-qUkMDT-IRddRQ")
...
def telegram_bot_sendphoto(photo_path, num_try=0):
    global bot
    try:
        return bot.send_photo(chat_id="1263299119", photo=open(photo_path, "rb"))
    except:
        if num_try == 1:
            bot = telegram.Bot(token="5044240470:AAFL0BRGxFu_L204lJGo1-qUkMDT-IRddRQ")
...
test = telegram_bot_sendtext("🔌 Bot inicializado na sua conta Lucas 😎" ". \n\n 💰 É hora de farmar alguns bcoins!!")
...
cat = """
 ================================================================================
 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 -----------------------INICIANDO O BOT DO LUCAS LINDO 😍------------------------
 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 ================================================================================"""
...
def goSaldo():
    ...
    time.sleep(2)
    enviar = ('🚨 Seu saldo de Bcoins até agora 🚀🚀🚀')
    ...
    while True:
        ...
        if now - last["new_map"] > t['check_for_new_map_button']:
            ...
            if clickBtn(images["new-map"]):
                telegram_bot_sendtext(f"Completamos mais um mapa Lucas! 🤩")
